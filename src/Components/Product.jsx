  ...
  return (
    <div className='w-full py-16 h-[23rem] text-white'>
        <div onMouseEnter={()=>{mover(count)}}  className="max-w-screen-xl mx-auto flex justify-between items-center">
           ...
           <p className='mb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam consectetur harum id quas? Quasi magni facilis voluptas? Asperiores, rerum labore!</p>
